...
This data is normally deleted quickly, but users can delay deletion by placing their device in airplane mode. The data these devices then have is placed on the Apple servers, and used for people to retrieve the location of their tracker reference.
\bigskip
...
\begin{figure}[ht]
    \centering
    \resizebox{\textwidth}{!}{\includegraphics{../dataflow_diagram.png}}
